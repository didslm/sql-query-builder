...
class AndGroup implements GroupCondition
{
    private const DEFAULT_OPERATOR = 'AND';
    private array $groupConditions = [];

    public static function create(ConditionInterface|GroupCondition ...$groups): AndGroup
    {
        $instance = new self();
